        ...
        try {
            ...
            if (json.success) {
                ...
                if (refreshed.success) {
                    setFormData({
                        site_name: refreshed.data.site_name,
                        ...
                        whatsapp: refreshed.data.whatsapp,
                        default_currency: refreshed.data.default_currency,
                    });

                    // ✅ SHOW SERVER-SAVED LOGO
                    setLogoPreview(refreshed.data.logo);
                }
            }
        } catch (error) {
